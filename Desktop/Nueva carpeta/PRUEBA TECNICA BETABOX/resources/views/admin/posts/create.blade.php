<x-layouts.admin title="Nuevo Post" section-title="Posts">
    <div class="row mt-10">
        <div class="col-md-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Crear Post</h6>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group @error('image') has-error @enderror">
                                        ...
                                        <div id="render-preview" class="mt-5 text-center">
                                            <h4>Por Favor selecciona una imagen</h4>
                                        </div>
                                        @error('image')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group @error('title') has-error @enderror">
                                        ...
                                        <input type="text" class="form-control" required="" id="title"
                                            name="title" placeholder="Ingrese el nombre" value="{{ old('title') }}">
                                        @error('title')
                                            <div class="help-block with-errors">
                                                <ul class="list-unstyled">
                                                    <li>{{ $message }}</li>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group @error('description') has-error @enderror">
                                        ...
                                        <textarea class="form-control" placeholder="descripción" name="description" rows="5">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="help-block with-errors">
                                                <ul class="list-unstyled">
                                                    <li>{{ $message }}</li>
